...
const updateIngredient = (state, action, addition) => {
    const updateIngredient = {
        [action.ingredientName]:
            state.ingredients[action.ingredientName] + addition,
    }
    ...
    const updatedState = {
        ...
        totalPrice:
            state.totalPrice +
            addition * INFGREDIENT_PRICES[action.ingredientName],
        building: building(updatedIngredients),
    }
